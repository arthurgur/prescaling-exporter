...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.prescalingV1, err = prescalingv1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.prescalingV1 = prescalingv1.New(c)
